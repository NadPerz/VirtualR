  ...
  return (
    <div className="flex flex-col item-center mt-6 lg:mt-20">
        <h1 className="text-4xl sm:text-6xl lg:text-7xl text-center tracking-wide">
            ...
            <span className='bg-gradient-to-r from-orange-500 to-red-800 text-transparent bg-clip-text'>{" "}for devolopers</span> 
        </h1>
        <p className='mt-10 text-lg text-center text-neutral-500 max-w-6xl'>
            Empower your creativity and bring your VR app ideas to life with our 
            intutive devolopment tools, Get started today and turn your imagination 
